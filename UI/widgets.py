...
def create_count_groupbox():
    ...
    checkbox_digit_sum_compare = QCheckBox("Tổng chữ số là một số")
    layout.addWidget(checkbox_digit_sum_compare, 2, 0)
    input_digit_sum_compare = QLineEdit()
    input_digit_sum_compare.setObjectName("digit_sum_compare_input")
    input_digit_sum_compare.setPlaceholderText("Nhập <,>,=,!=,<=,>= số")
    input_digit_sum_compare.setEnabled(False)
    layout.addWidget(input_digit_sum_compare, 2, 1)
    checkbox_digit_sum_compare.toggled.connect(lambda checked: input_digit_sum_compare.setEnabled(checked))
    checkbox_digit_sum_compare.setObjectName("checkbox_digit_sum_compare")
    ...
    checkbox_remainder = QCheckBox("Số chia dư")
    layout.addWidget(checkbox_remainder, 4, 0)
    input_remainder = QLineEdit()
    input_remainder.setObjectName("remainder_input")
    input_remainder.setPlaceholderText("Nhập %a=b")
    input_remainder.setEnabled(False)
    layout.addWidget(input_remainder, 4, 1)
    checkbox_remainder.toggled.connect(lambda checked: input_remainder.setEnabled(checked))
    checkbox_remainder.setObjectName("checkbox_remainder")

    checkbox_starts_by = QCheckBox("Bắt đầu bằng")
    layout.addWidget(checkbox_starts_by, 5, 0)
    ...
    layout.addWidget(input_starts_by, 5, 1)
    ...
    layout.addWidget(checkbox_not_starts_by, 5, 2)
    ...
    layout.addWidget(input_not_starts_by, 5, 3)
    ...
    checkbox_starts_by_0 = QCheckBox("Bắt đầu bằng 0 (đặc biệt)")
    checkbox_starts_by_0.setObjectName("checkbox_starts_by_0")
    layout.addWidget(checkbox_starts_by_0, 10, 2)
    ...
    layout.addWidget(checkbox_divisible_by, 7, 0)
    ...
    layout.addWidget(input_divisible_by, 7, 1)
    ...
    layout.addWidget(arithmetic_checkbox, 8, 0)
    ...
    layout.addWidget(arithmetic_input, 8, 1)
    ...
    layout.addWidget(geometric_checkbox, 8, 2)
    ...
    layout.addWidget(geometric_input, 8, 3)
    ...
    checkbox_not_divisible_by = QCheckBox("Không chia hết cho")
    layout.addWidget(checkbox_not_divisible_by, 7, 2)
    input_not_divisible_by = QLineEdit()
    input_not_divisible_by.setObjectName("not_divisible_input")
    input_not_divisible_by.setPlaceholderText("Nhập a,b,c,...")
    input_not_divisible_by.setEnabled(False)
    layout.addWidget(input_not_divisible_by, 7, 3)
    checkbox_not_divisible_by.toggled.connect(lambda checked: input_not_divisible_by.setEnabled(checked))
    checkbox_not_divisible_by.setObjectName("checkbox_not_divisible_by")

    checkbox_includes_digits = QCheckBox("Luôn có mặt các chữ số")
    layout.addWidget(checkbox_includes_digits, 9, 0)
    ...
    layout.addWidget(input_includes_digits, 9, 1)
    ...
    layout.addWidget(checkbox_specific_positions, 10, 0)
    ...
    layout.addWidget(input_specific_positions, 10, 1)
    ...
    layout.addWidget(calculate_button, 11, 0, 1, 5)
    print("start")
